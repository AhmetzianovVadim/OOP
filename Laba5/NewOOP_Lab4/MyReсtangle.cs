...
{
    public class MyReсtangle : Square
    {
        private int h;
        private static Random randomint = new Random();
        public MyReсtangle()
        {
            this.h = randomint.Next(20, 100);
        }

        public MyReсtangle(int x, int y, int w, int h, bool visibility, int redcolor, int greencolor, int bluecolor) : base(x, y, w, visibility, redcolor, greencolor, bluecolor)
        {
            this.h = h;
        }
